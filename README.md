...
<h4>My GitHub Language Usage</h4>
    <canvas id="languageChart" width="400" height="400"></canvas>

    <script>
        // Example data
        const languages = ['Python', 'JavaScript', 'HTML', 'CSS', 'Others'];
        const timeSpent = [50, 20, 15, 10, 5]; // Time in hours or percentage
        ...
        const languageChart = new Chart(ctx, {
            ...
            data: {
                labels: languages,
                datasets: [{
                    label: 'Time Spent on Programming Languages',
                    data: timeSpent,
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(54, 162, 235, 0.2)',
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Time Spent on Programming Languages'
                    }
                }
            }
        });
